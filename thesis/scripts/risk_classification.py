...
def run_classification_pipeline(prep, dataset_type, output_dir):
    ...
    metrics_path = output_dir / "Metrics" / f"metrics_classification_{dataset_type}.csv"
    predictions_path = output_dir / "Predictions" / f"predictions_classification_{dataset_type}.csv"
